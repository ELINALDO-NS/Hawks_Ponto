...
{
    public class AtualizaHorarioValidator:AbstractValidator<AtualizaHorarioDto>
    {
        public AtualizaHorarioValidator()
        {

            RuleFor(x => x.Id)
         .GreaterThan(0)
         .WithMessage("Id deve ser informado e maior que zero.");
