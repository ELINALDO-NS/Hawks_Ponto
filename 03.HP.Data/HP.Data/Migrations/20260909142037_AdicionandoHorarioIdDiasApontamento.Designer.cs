...
namespace HP.Data.Migrations
{
    ...
    [Migration("20260909142037_AdicionandoHorarioIdDiasApontamento")]
    partial class AdicionandoHorarioIdDiasApontamento
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HP.Core.Entities.Jornada", b =>
                {
                    ...
                    b.Property<int>("MinutosCargaHoraria")
                        ...
                        .HasColumnType("int")
                        .HasComputedColumnSql("DATEDIFF(MINUTE, Entrada1, Saida1) + ISNULL(DATEDIFF(MINUTE, Entrada2, Saida2), 0) + ISNULL(DATEDIFF(MINUTE, Entrada3, Saida3), 0)", true);
